...
{
    #[Route('/', name: 'index')]
    public function index(SessionInterface $session, ProductsRepository $productsRepository,CategoriesRepository $categoriesRepository)
    {
        ...
        //return $this->render('', compact('data', 'total'));
